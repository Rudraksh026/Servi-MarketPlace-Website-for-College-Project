                  ...
                  <form action="login.php" method="post"  class="row g-3 needs-validation" novalidate id="login-frm">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input name="usrname" type="text" name="username" class="form-control" id="yourUsername" required>
                    ...
                    <div class="col-12">
                      ...
                      <input name="pass" type="password" name="password" class="form-control" id="yourPassword" required>
